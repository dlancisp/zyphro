...
export const Icons = {
  // ✅ NUEVO LOGO (Hexágono azul con Z blanca)
  Logo: () => (
    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M21 16V8L12 3L3 8V16L12 21L21 16Z" fill="#2563EB"/>
      <path d="M7.5 8.5H16.5L9 16H16.5" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
